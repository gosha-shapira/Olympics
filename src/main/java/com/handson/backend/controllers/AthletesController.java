...
public class AthletesController {
    ...
    public ResponseEntity<?> createAthlete(@RequestBody AthleteIn athleteIn) {
    ...
    public ResponseEntity<?> updateAthlete(@PathVariable Long id, @RequestBody AthleteIn athlete) {
        Optional<Athlete> dbAthlete = athleteService.findById(id);
        if (dbAthlete.isEmpty()) throw new RuntimeException("Athlete with id: " + id + " not found");
